export const PARTS = [
    ...
    },
    {
        ...
        color:{h:120, s:50, l:70}, timeLimit:20,
    ...
    },
    {
        ...
        color:{h:50, s:80, l:50}, timeLimit:20,
    ...
    },
    {
        ...
        color:{h:200, s:30, l:70}, timeLimit:20,
    ...
    {
        name:'Корпус мотора',
        desc:'Внешняя оболочка дрона.',
        facts:['Закрывает плату и внутренности','Имеет крепления для рук и камеры','Часто с декоративными элементами'],
        quiz:{q:'Что закрывает верхняя крышка?',opts:['Пропеллеры','Плату и внутренности','Батарею'],ans:1},
        color:{ h: 195, s: 85, l: 75 }
        , timeLimit:20,
        targetPos:new BABYLON.Vector3(0,0.18,0),
        targetEuler:new BABYLON.Vector3(0,0,0),
        modelFile:'verh_korp.glb',
        scale: 1.0
    },
];
